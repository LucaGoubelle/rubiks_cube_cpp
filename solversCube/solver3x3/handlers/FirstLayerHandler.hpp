...
class FirstLayerHandler : public Handler {
    private:
        ...
        WBRProcessor wbrProc;
        WGRProcessor wgrProc;
        WGOProcessor wgoProc;
        WBOProcessor wboProc;
        ...
        Cube insertWBR(Cube cube){
            ...
            std::string sequence = this->wbrProc.process(targetedOrientColors);
        ...
        Cube insertWGR(Cube cube){
            ...
            std::string targetedOrientColors = this->cornerSeeker.seekCorner(cube, posibilities);
            std::string sequence = this->wgrProc.process(targetedOrientColors);
            cube = this->mover.multiMoves(cube, sequence);
            return cube;
        }
        ...
        Cube insertWGO(Cube cube){
            ...
            std::string targetedOrientColors = this->cornerSeeker.seekCorner(cube, posibilities);
            std::string sequence = this->wgoProc.process(targetedOrientColors);
            cube = this->mover.multiMoves(cube, sequence);
            return cube;
        }
        ...
        Cube insertWBO(Cube cube){
            ...
            std::string targetedOrientColors = this->cornerSeeker.seekCorner(cube, posibilities);
            std::string sequence = this->wboProc.process(targetedOrientColors);
            cube = this->mover.multiMoves(cube, sequence);
            return cube;
        }
    public:
