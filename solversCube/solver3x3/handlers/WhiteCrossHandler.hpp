...
class WhiteCrossHandler {
    private:
        ...
        Cube insertWB(Cube cube){
            ...
            std::string finalVerif = this->scanner.scanEdge(cube, "down_front");
        ...
        Cube insertWR(Cube cube){
            ...
            // verify orientation in slot
            std::string finalVerif = this->scanner.scanEdge(cube, "down_right");
            // correct the orientation
        ...
        Cube insertWG(Cube cube){
            ...
            // verify orientation in slot
            std::string finalVerif = this->scanner.scanEdge(cube, "down_back");
            // correct the orientation
        ...
        Cube insertWO(Cube cube){
            ...
            // verify orientation in slot
            std::string finalVerif = this->scanner.scanEdge(cube, "down_left");
            // correct the orientation
